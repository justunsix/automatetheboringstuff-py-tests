...
#+title: Jupyter like Functionality in Emacs Org-mode

* Heading based settings for specific Environment, Python Notebook
:PROPERTIES:
...
#+RESULTS:
[[file:/home/user/Code/myproject/.venv/bin/python]]
...
#+RESULTS:
: /home/user/Code/myproject/.venv/bin/python
