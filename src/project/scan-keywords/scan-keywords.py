...
def scan_file(file_path, keywords):
    """Scan a file with a keywords list and when there is a match in the
    keyword (match is case insensitive),
    return the line number and full line.
    At end of file, return keywords and number of matches in the file
    for keywords that had a match."""
        ...
        for line_number, line in enumerate(file_lines, 1):
            for keyword in keywords:
                if keyword.lower() in line.lower():
                    print("| Keyword: " + keyword + " found in line " +
                          str(line_number) + ": " + line)
        print("| ============================================================")
        print("| Number of matches for each keyword:")
        for keyword in keywords:
            keyword_count = 0
            # if keyword begins with "##" just print the keyword and move to
            # next list item since it is a group
            if keyword.startswith("##"):
                ...
                if keyword_count > 0:
                    ...
                    print("| \033[1;32;40m", keyword, " found " +
                          str(keyword_count) + " times.\033[0;37;40m")
                else:
                    # print found with ansi red color
                    print("| \033[1;31;40m", keyword,
                          " not found.\033[0;37;40m")
...
# Iterate over the list of files and call scan_file function with the
# keywords list
