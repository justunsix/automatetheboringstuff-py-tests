        ...
        if cog_endpoint is not None and cog_key is not None:
            ...
            if len(detected_faces) > 0:
                ...
                for face in detected_faces:
                    ...
                    print(
                        " - Head Pose (Yaw): {}".format(
                            face.face_attributes.head_pose.yaw
                        )
                    )
                    print(
                        " - Head Pose (Pitch): {}".format(
                            face.face_attributes.head_pose.pitch
                        )
                    )
                    print(
                        " - Head Pose (Roll): {}".format(
                            face.face_attributes.head_pose.roll
                        )
                    )
                    print(
                        " - Forehead occluded?: {}".format(
                            face.face_attributes.occlusion["foreheadOccluded"]
                        )
                    )
                    print(
                        " - Eye occluded?: {}".format(
                            face.face_attributes.occlusion["eyeOccluded"]
                        )
                    )
                    print(
                        " - Mouth occluded?: {}".format(
                            face.face_attributes.occlusion["mouthOccluded"]
                        )
                    )
                    print(" - Accessories:")
