...
def main():
    ...
    try:
        ...
        if key is not None and endpoint is not None:
            ...
            # Display invoice information to the user# Display invoice information to the user
            ...
            for idx, receipt in enumerate(receipts.documents):
                ...
                if invoice_total:
                    print(
                        f"Invoice Total: '{invoice_total.value.symbol}{invoice_total.value.amount}, with confidence {invoice_total.confidence}."
                    )
